...
Консольная программа для моделирования интерференции в схеме Юнга.

Возможности:
1. Монохроматический точечный источник:
   - аналитическая формула интенсивности;
   - численное суммирование комплексных амплитуд от двух щелей;
   - сравнение периода полос.

2. Протяжённый источник:
   - аналитическая видность V = |sinc(b d / (lambda L1))|;
   - численное некогерентное суммирование картин от точек источника.

3. Квазимонохроматический источник:
   - усреднение по длинам волн;
   - зависимость видности от ширины спектра и порядка полосы.
...
Запуск:
    python3 m10_interference.py

Все величины вводятся в СИ:
    длина волны: м, например 550e-9
    расстояние между щелями: м, например 0.5e-3
    расстояния L1, L2: м
    ширина экрана: м
"""
